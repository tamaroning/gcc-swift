// Modified version of swift-system.h
// swift-system.h -- Rust frontend inclusion of gcc header files   -*- C++ -*-
...
#ifndef SWIFT_SYSTEM_H
#define SWIFT_SYSTEM_H
...
// Swift frontend requires C++11 minimum, so will have unordered_map and set
...
// When using gcc, swift_assert is just gcc_assert.
#define swift_assert(EXPR) gcc_assert(EXPR)

// When using gcc, swift_unreachable is just gcc_unreachable.
#define swift_unreachable() gcc_unreachable()

extern void swift_preserve_from_gc(tree t);
